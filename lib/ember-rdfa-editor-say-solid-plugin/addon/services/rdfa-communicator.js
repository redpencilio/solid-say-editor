...
export default class RdfaCommunicatorService extends Service {
    ...
    fromRDFa(block, triples, editor) {
        ...
        triples.forEach(triple => {
            ...
            if (triple.predicate !== "a" && triple.subject !== "#") {
                ...
                if (dels && dels[0].object.value.trim() !== replacementValue.trim()) {
                    console.log("called");
    ...
    processNode(oldQuad, domNode, domAttrReplaceValObj, rdfWrapper, editor) {
        ...
        console.log(this.store.match(subjectNode, predicateNode, undefined, graphNode));
        ...
        console.log(editor.selectCurrentSelection());
