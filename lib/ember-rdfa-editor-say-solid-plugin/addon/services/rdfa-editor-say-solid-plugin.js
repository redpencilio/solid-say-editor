...
export default class RdfaEditorSaySolidPlugin extends Service {
   ...
   * @type {BlockHandler[]}
   */
  solidHandlers = [this.owner.lookup(EDIT_EDITOR_KEY), FetchBlockHandler, LoginBlockHandler, FilesBlockHandler, TypesBlockHandler, this.owner.lookup(RESET_KEY), this.owner.lookup(SAVE_KEY)];
