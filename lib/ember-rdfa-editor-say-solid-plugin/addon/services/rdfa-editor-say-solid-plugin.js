...
import { SAVE_REST_KEY } from '../utils/block-handlers/save-reset-block-handler';
...
export default class RdfaEditorSaySolidPlugin extends Service {
   ...
   * @type {BlockHandler[]}
   */
  solidHandlers = [this.owner.lookup(EDIT_EDITOR_KEY), FetchBlockHandler, LoginBlockHandler, FilesBlockHandler, TypesBlockHandler, this.owner.lookup(SAVE_REST_KEY)];
