 ...
 * @property {BlockHandler[]} solidHandlers Contains the handlers which will be notified for every events from the editor dispatcher. 
 */
export default class RdfaEditorSaySolidPlugin extends Service {
   ...
   * @memberof RdfaEditorSaySolidPlugin
   */
