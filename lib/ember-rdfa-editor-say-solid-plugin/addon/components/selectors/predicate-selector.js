 ...
 * @property {Boolean} popup Boolean that indicates whether a triple-creation popup is shown
 * @property {Set} selectedQuads Set of selected quads in the predicate selector
 * @property {Boolean} isLoading Indicates whether the quads are being fetched
 */
export default class PredicateSelectorComponent extends Component {
  ...
  */
  ...
  /**
   * Adds or removes a quad from the selected quads
   *
   * @method onSelect
   *
   * @memberof PredicateSelectorComponent
   * @param {Statement} quad The quad to be added or removed
   * @public
   */
  @action
  onSelect(quad) {
   ...
   *
   * @memberof PredicateSelectorComponent
   * @param {Statement} quad The quad to be added
   * @public
   */
  @action
