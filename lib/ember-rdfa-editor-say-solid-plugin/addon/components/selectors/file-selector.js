 ...
 * @property {Folder} root Represents the root folder of the Solid pod
 * @property {Boolean} popup Boolean that indicates whether a file-creation popup is shown
 * @property {Folder} selectedFolder The currently selected folder in the file-tree
 */
export default class FileSelectorComponent extends Component {
   ...
   * @method fetchFiles
   *
   * @memberof FileSelectorComponent
   * 
   * @public
   */
    @action
    ...
    /**
     * Sets the currently selected folder in the filetree
     *
     * @method setSelectedFolder
     * 
     * @param {Folder} folder The given folder
     *
     * @memberof FileSelectorComponent
