 ...
 * 
 * @property {Object} forms a mapping of UUID to {@link Form} object 
 * @property {Integer} errorCount number of errors in the forms, on the current modal component
 * @property {Object} validators a mapping of RDF property name ["predicate", "object" ,...] to an Array of {validatorFunc, errorMsg} 
 */
export default class ModalComponent extends Component {
     ...
     * @method addForm
     * 
     * @param {Object} model custom object mapping properties' name ["subject", "predicate", ...] to values. 
     *                       Used by the corresponding form object.
     * 
     * @memberof ModalComponent
     */
    @action
     ...
     * @method validate
     * 
     * @param {String}  uuid UUID of the form in which the validation will be done
     * @param {String}  propertyName name of the property whose value will be validated 
     * 
     * @memberof ModalComponent
     */
    ...
    /**
     * Handles the change due to user's input in the form
     * @memberof ModalComponent
     * @param {String} uuid UUID of the form for which there is a change in values
     * @param {String} propertyName name of the property for which the value has been changed
     */
    @action
