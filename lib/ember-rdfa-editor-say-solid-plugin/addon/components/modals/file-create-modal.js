...
export default class FileCreateModalComponent extends ModalComponent {
    ...
    addForm() {
        ...
        form.model = { file: "" };
        form.addValidator("file", validateNotEmpty, "File name may not be empty.");
        form.addValidator("file", validateFileName, "File name may not contain spaces or special characters.");
        for(let propertyName in form.model){
